...
(9, 'GLD0000009', 23, '格子裡的異世界', '2026-08-28', 'guild-avatars/guild_734b9d4018388b.11697647.jpg', '熱血、奇幻、日常都可以，一起追連載、聊分鏡、認親愛的角色。', 0, 4, '正常', '', '📌 公會版規\n1. 請尊重每位成員，禁止人身攻擊與歧視性言論\n2. 追連載請標註集數/話數，避免暴雷\n3. 歡迎二創與角色討論，但請勿散播盜版連結\n4. 討論書籍內容前請標註「雷」，避免暴雷'),
(10, 'GLD0000010', 25, '慢活雜貨店', '2026-08-28', 'guild-avatars/guild_d0ac07cea03158.47174570.jpg', '斷捨離、極簡、慢生活，一起把日子過得更有品質一點。', 0, 5, '正常', '', '📌 公會版規\n1. 請尊重每位成員，禁止人身攻擊與歧視性言論\n2. 分享生活方式純屬個人選擇，請勿批評他人的生活步調\n3. 歡迎分享斷捨離或簡化生活的小技巧\n4. 討論書籍內容前請標註「雷」，避免暴雷');
...
--
ALTER TABLE `guilddiscussion`
  MODIFY `message_id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '訊息編號', AUTO_INCREMENT=66;
...
--
ALTER TABLE `notification`
  MODIFY `notifi_id` int(11) NOT NULL AUTO_INCREMENT COMMENT '通知編號', AUTO_INCREMENT=7;
