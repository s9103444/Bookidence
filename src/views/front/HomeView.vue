...
export default {
  ...
  data() {
    return {
      books: [
        { id: 1, cover: new URL('@/assets/images/peter-cover.png', import.meta.url).href, title: '彼得原理', author: '勞倫斯·彼得', categories: ['商業財經', '領導管理'] },
        { id: 2, cover: new URL('@/assets/images/peter-cover.png', import.meta.url).href, title: '彼得原理', author: '勞倫斯·彼得', categories: ['商業財經', '領導管理'] },
        { id: 3, cover: new URL('@/assets/images/peter-cover.png', import.meta.url).href, title: '彼得原理', author: '勞倫斯·彼得', categories: ['商業財經', '領導管理'] },
        { id: 4, cover: new URL('@/assets/images/peter-cover.png', import.meta.url).href, title: '彼得原理', author: '勞倫斯·彼得', categories: ['商業財經', '領導管理'] },
        { id: 5, cover: new URL('@/assets/images/peter-cover.png', import.meta.url).href, title: '彼得原理', author: '勞倫斯·彼得', categories: ['商業財經', '領導管理'] },
        { id: 6, cover: new URL('@/assets/images/peter-cover.png', import.meta.url).href, title: '彼得原理', author: '勞倫斯·彼得', categories: ['商業財經', '領導管理'] },
        { id: 7, cover: new URL('@/assets/images/peter-cover.png', import.meta.url).href, title: '彼得原理', author: '勞倫斯·彼得', categories: ['商業財經', '領導管理'] },
        { id: 8, cover: new URL('@/assets/images/peter-cover.png', import.meta.url).href, title: '彼得原理', author: '勞倫斯·彼得', categories: ['商業財經', '領導管理'] },
      ],
      breakpoints: {
...
<template>
  ...
  <section class="intro-homeroom container">
    ...
    <div class="col-5 img-homeroom-intro">
      <img src="@/assets/images/home-element/house.png" alt="" style="width: 100%" />
    </div>
  </section>
  ...
  <div class="recommand-book-section">
    ...
    <Carousel ref="carouselRef" :items-to-show="1" :items-to-scroll="1" :breakpoints="breakpoints" :gap="24"
